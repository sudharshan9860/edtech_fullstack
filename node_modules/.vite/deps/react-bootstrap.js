...
var divWithClassName_default = (className) => (
  ...
  React14.forwardRef((p, ref) => (0, import_jsx_runtime10.jsx)("div", {
    ...p,
    ref,
...
var TabContent = React136.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React137.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var ToastFade = React140.forwardRef((props, ref) => (0, import_jsx_runtime142.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React141.createContext({
  onClose() {
  }
});
...
var ToastHeader = React142.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
...
var ToastBody = React143.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastContainer = React145.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop6 = () => void 0;
var ToggleButton = React146.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React147.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime151.jsx)(ButtonGroup_default, {
    ...
    children: map(children, (child) => {
      ...
      return React147.cloneElement(child, {
        type,
