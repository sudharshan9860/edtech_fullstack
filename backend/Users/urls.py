...
from Users.views import TeacherOnlyAPIView,AllStudentsAPIView,BulkTeacherUploadAPIView
urlpatterns = [
    ...
    path('teacherupload/', BulkTeacherUploadAPIView.as_view(), name='teacher-upload'),  # Example of a bulk upload view for teachers
