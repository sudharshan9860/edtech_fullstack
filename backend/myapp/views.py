        ...
        # BASE_URL = "http://139.59.86.115/api/generate-concepts-required/"
            ...
            if response.status_code == 200:
                ...
                for idx,concepts in enumerate(concepts):
                    number=idx+1
                    conceptname="concept_name "+str(idx+1)+": "+concepts['concept_name']
                    step_by_step_concepts.append(conceptname)
                    conceptdescription="concept_description: "+concepts['concept_description']
                    step_by_step_concepts.append(conceptdescription)
                    conceptexample="concept_example: "+concepts['concept_example']
